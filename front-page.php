...
<style>
    .reasons {
        background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'reasons_img'); ?>);
        background-color: <?php echo carbon_get_post_meta(get_the_ID(), 'reasons_background'); ?>;
    }
    .quote-first {
        background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'first_quote_img'); ?>);
        background-color: <?php echo carbon_get_post_meta(get_the_ID(), 'first_quote_background'); ?>;
    }
    .quote-second {
        background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'second_quote_img'); ?>);
        background-color: <?php echo carbon_get_post_meta(get_the_ID(), 'second_quote_background'); ?>;
    }
    .result {
        background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'result_img'); ?>);
        background-color: <?php echo carbon_get_post_meta(get_the_ID(), 'result_background'); ?>;
    }
    @media (max-width:394px) {
        .reasons {
            background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'reasons_img_mobile'); ?>);
            background-size: contain;
        }
        .quote-first {
            background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'first_quote_img_mobile'); ?>);
        }
        .quote-second {
            background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'second_quote_img_mobile'); ?>);
        }
        .result {
        background-image: url(<?php echo carbon_get_post_meta(get_the_ID(), 'result_img_mobile'); ?>);
    }
    }
</style>
<main class="main">
    ...
    <div class="quote quote-second section">
        <div class="container">
            ...
            <div class="quote__subtext quote__subtext--desktop">
                <?php echo carbon_get_post_meta(get_the_ID(), 'second_quote_text_bottom'); ?>
            </div>
            <div class="quote__subtext quote__subtext--mobile">
                <?php echo carbon_get_post_meta(get_the_ID(), 'second_quote_text_bottom_mobile'); ?>
            </div>
        </div>
    </div>
